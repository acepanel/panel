...
// CreateStreamServer 创建 Stream Server 请求
type CreateStreamServer struct {
	StreamServer
}

// UpdateStreamServer 更新 Stream Server 请求
type UpdateStreamServer struct {
	StreamServer
}

// CreateStreamUpstream 创建 Stream Upstream 请求
type CreateStreamUpstream struct {
	StreamUpstream
}

// UpdateStreamUpstream 更新 Stream Upstream 请求
type UpdateStreamUpstream struct {
	StreamUpstream
}
